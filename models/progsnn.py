...
class ProGSNN_ATLAS_prop(TGTransformerBaseModel_ATLAS_prop):

    def __init__(self, hparams):
        super(ProGSNN_ATLAS_prop, self).__init__(hparams)
...
class ProGSNN_ATLAS_noT(TGTransformerBaseModel_ATLAS_noT):

    def __init__(self, hparams):
        super(ProGSNN_ATLAS_noT, self).__init__(hparams)
        ...
        # Auxiliary network
        self.bottleneck_module = BaseBottleneck(
            self.scattering_network.out_shape()*self.residue_num,
            self.hidden_dim,
            self.latent_dim)
    ...
    def encode(self, batch):
        ...
        # import pdb; pdb.set_trace()
        # print(coeffs_recon)
        return z_rep, coeffs, coeffs_recon, att_maps

    def forward(self, batch):
        # print(self.scattering_network.out_shape())
        z_rep, coeffs, coeffs_recon, att_maps = self.encode(batch)
        ...
        # import pdb; pdb.set_trace()
        # y_pred = self.softmax(y_pred)
        return y_pred, z_rep, coeffs_recon, coeffs, att_maps, coords_recon
