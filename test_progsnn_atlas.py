...
if __name__ == '__main__':
    ...
    #test model
    trained_weights = torch.load('train_logs/progsnn_logs_run_atlas_2024-08-20-49/model_atlas_1ptq.npy')
    ...
    with open(f'latent_embeddings{args.protein}_notime.pkl', 'wb') as file:
        pickle.dump(latent_embeddings, file)
    
    print("Saving times..")
    with open(f'times_{args.protein}_notime.pkl', 'wb') as file:
        pickle.dump(times, file)
    
    # print("Saving coordinates..")
    # with open(f'coords_{args.protein}_notime.pkl', 'wb') as file:
