...
def load_data():
    traj = md.load("1ab1_A_prod_R1_fit.xtc", top= "1ab1_A.pdb")
...
def create_pyg_graph(traj, frame_idx, property):
    ...
    graph = Data.Data(x=node_features, coords=residue_coords, time=timepoint, num_nodes=len(residue_names), y = y)
